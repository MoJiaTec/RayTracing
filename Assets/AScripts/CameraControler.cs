...
public class CameraControler : MonoBehaviour {
    ...
    void Update() {
        ...
        {
            camera.transform.localPosition = camera.transform.position + camera.transform.forward * moveSpd * scale;
        }
        ...
        {
            camera.transform.localPosition = camera.transform.position - camera.transform.right * moveSpd * scale;
        }
